<?= form_open_multipart($this->uri->uri_string(),array('id'=>'formauth','class'=>'formular')); ?>
	...
	<div class="form-edit-text">
		...
		<input class="small-text-form-input input-date" type="text" name="bdate" maxlength="50" value="<?=set_value('bdate');?>">
		<input class="small-text-form-input input-date" type="text" name="edate" maxlength="50" value="<?=set_value('edate');?>">
		<div class="clear"></div>
