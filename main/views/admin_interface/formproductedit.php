<?= form_open_multipart($this->uri->uri_string(),array('id'=>'formauth','class'=>'formular')); ?>
	<?=form_hidden('id',$this->uri->segment(5));?>
	...
	<div class="form-edit-text">
		...
		<div class="clear"></div>
		<b>Цена:</b><br/>
		<input class="text-form-input" type="text" name="price" maxlength="50" value="<?=$content['price'];?>">
		<input class="small-text-form-input" type="text" name="currency" maxlength="50" value="<?=$content['currency'];?>">
		<div class="clear"></div>
